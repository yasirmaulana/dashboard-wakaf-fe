...
<template>
  <header class="sticky top-0 z-30 flex h-20 items-center gap-4 border-b bg-background/60 px-8 backdrop-blur-xl">
    <!-- Search Bar -->
    <div class="flex flex-1 items-center max-w-md">
      <div class="relative w-full group">
        ...
        <input
          type="search"
          placeholder="Cari aset, kode, atau wakif..."
    ...
    <div class="flex items-center gap-3 ml-auto">
      <button class="relative rounded-xl p-2.5 text-muted-foreground hover:bg-primary/5 hover:text-primary transition-all duration-200">
        <Bell class="h-5 w-5" />
        <span class="absolute right-2.5 top-2.5 h-2 w-2 rounded-full bg-destructive border-2 border-background"></span>
      </button>

      <button class="rounded-xl p-2.5 text-muted-foreground hover:bg-primary/5 hover:text-primary transition-all duration-200">
